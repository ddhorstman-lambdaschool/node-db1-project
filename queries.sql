...
--         '111',
--         'Middle Earth');
-- NOTE: This database has its primary key configured incorrectly, so it has to be manually entered.
-- I wasn't able to figure out how to fix it.
...
-- (Stretch) Find a query to discover how many different cities are stored
-- in the Customers table. Repeats should not be double counted
